...
const courseSchema = z.object({
  name: z.string().min(2),
  level: z.string(),
  courseGroup: z.string().optional().nullable(),
  ...
  hoursOneOnOne: z.number().optional().nullable(),
  hoursGroup: z.number().optional().nullable(),
  blockHours: z.number().optional().nullable(),
  priceOneOnOne: z.number().optional().nullable(),
  priceGroup2to5: z.number().optional().nullable(),
  priceGroup6to10: z.number().optional().nullable(),
  pdfPrice: z.number().optional().nullable(),
